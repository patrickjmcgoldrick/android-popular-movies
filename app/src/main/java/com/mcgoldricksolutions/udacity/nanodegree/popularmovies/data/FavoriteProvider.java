...
public class FavoriteProvider extends ContentProvider {
    ...
    static UriMatcher buildUriMatcher() {
        ...
        // FavoriteContract to help define the types to the UriMatcher.
        matcher.addURI(FavoriteContract.CONTENT_AUTHORITY, FavoriteContract.BASE_PATH, FAVORITES);
        matcher.addURI(FavoriteContract.CONTENT_AUTHORITY, FavoriteContract.BASE_PATH + "/#", FAVORITE);
    ...
    public String getType(Uri uri) {
        ...
        Log.d("FavoriteProvider","URI: " + uri);
        Log.d("FavoriteProvider","URI matches: " + match);
